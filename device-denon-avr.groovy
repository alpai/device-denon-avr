...
metadata {
    definition (name: "Denon AVR Zone2", namespace: "SB", 
...
preferences {
	...
	tiles(scale: 2) {
        ...
        controlTile("z2Control", "device.z2Level", "slider", height: 1, width: 3, inactiveLabel: false) {
            state "level", action:"setLevelz2", label:'Zone2 Volume'
        }
        standardTile("input7", "device.game", width: 2, height: 2, decoration: "flat"){
        	state "OFF", label: 'Chromecast', action: "game", icon:"st.Electronics.electronics5", backgroundColor: "#FFFFFF",nextState:"ON"   
            state "ON", label: 'Chromecast', action: "game", icon:"st.Electronics.electronics5", backgroundColor: "#53a7c0", nextState:"OFF"   
			} 
        ...
        standardTile("input4", "device.z2cd", width: 2, height: 2, decoration: "flat"){
        	state "OFF", label: 'Z2 Cast Audio', action: "z2cd", icon:"st.Electronics.electronics14", backgroundColor: "#FFFFFF",nextState:"ON"   
            state "ON", label: 'Z2 Cast Audio', action: "z2cd", icon:"st.Electronics.electronics14", backgroundColor: "#53a7c0", nextState:"OFF"               
        	}
		standardTile("input5", "device.mp", width: 2, height: 2, decoration: "flat"){
        	state "OFF", label: 'Rasplex', action: "mp", icon:"st.Electronics.electronics9", backgroundColor: "#FFFFFF",nextState:"ON"   
            state "ON", label: 'Rasplex', action: "mp", icon:"st.Electronics.electronics9", backgroundColor: "#53a7c0", nextState:"OFF"              
			}
        ...
        standardTile("input8", "device.cd", width: 2, height: 2, decoration: "flat"){
        	state "OFF", label: 'Cast Audio', action: "cd", icon:"st.Entertainment.entertainment2", backgroundColor: "#FFFFFF",nextState:"ON"   
            state "ON", label: 'Cast Audio', action: "cd", icon:"st.Entertainment.entertainment2", backgroundColor: "#53a7c0", nextState:"OFF"             
			}           
...
main "multiAVR"
        details(["multiAVR", "z2Control", "input7", "input8", "input2", "input3","input4", "input5", "input6","input1", "input10", "input11", "input12","input13", "input14", "zone2", "poll"])
    }
}
def parse(String description) {
    ...
    def request(body) { 
		...
		log.debug "Sending AV cmd - ${destIp}:${destPort}/MainZone/index.put.asp?${body}"

        def hubAction = new physicalgraph.device.HubAction(
                'method': 'POST',
                'path': "/MainZone/index.put.asp",
                'body': body + "&ZoneName=ZONE2",,
                'headers': [ HOST: "$destIp:$destPort" ]
            ) 
